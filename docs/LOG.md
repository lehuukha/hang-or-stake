...
## 2026-09-08 - Codex, forecasts and booking access
- Added a compact booking action and expandable live seven-day NWS forecast to every campsite detail, including trip logs. Temperatures, precipitation probability, wind and update timestamp come from NWS; unknowns remain unknown. Requests occur only on expansion, cache in memory for 15 minutes, time out after 15 seconds, reject stale/empty data, and retain a direct NWS fallback.
- Forecasts use sourced area reference points from PARK_LOCATIONS, explicitly not campsite measurements. Broad forest/river references retain named-location scope.
- Booking links route to the official MN DNR, Three Rivers, Washington County and Wright County services. Governor Knowles links to backpack permit instructions; first-come/dispersed sites link to official rules. B1 closure and unverified Minnesota Valley sites have status links instead of booking promises. Booking systems require choosing dates and the particular site/category.
- Sources checked: https://www.dnr.state.mn.us/reserve ; https://www.threeriversparks.org/activity/camping ; https://washingtoncountymn.gov/1820/Camping-Reservations ; https://www.wrightcountymn.gov/Facilities/Facility/Details/Stanley-Eddy-Regional-Park-Reserve-23 ; https://dnr.wisconsin.gov/topic/StateForests/govknowles/recreation/camping ; https://www.nps.gov/sacn/planyourvisit/camping.htm ; https://www.weather.gov/documentation/services-web-api . First-come Rice County evidence remains in the inventory audit.
- Runnable check: node tests/trip_planning.cjs. Checks all campsite mappings, closures, zero/missing values, escaped source content and stale/empty forecasts. Desktop live NWS rendering verified. No campsite scores or owner reports changed.
- Final verification: live day/night forecast and booking panel checked on desktop and both 320/390px phone frames with no horizontal overflow; no browser errors. Offline fallback and retry guard checked. Published on main.

## 2026-09-08 - Codex, integrated forecast refinement
- Replaced the detached booking block and 14-cell weather table with an integrated overview section: quiet booking action beside the heading, seven calendar-day columns, consistent line icons, paired daytime/overnight temperatures, and an on-demand full wind/precipitation outlook. Forecast loads only when a campsite overview is opened; existing request cache, source validation and stale-data handling remain.
- Phone layout uses a keyboard-focusable horizontal forecast strip, visible next-day clipping, and two-line condition previews. Complete wording remains available in the outlook. Location/booking explanations are disclosed; closure/unverified status remains visible. No scores, reports or reservation targets changed.
- Verified live NWS rendering, desktop/phone composition, no page overflow, and full-outlook disclosure. All automated checks pass, including day/night grouping and offline Retry. The initial updated test exposed a degree-symbol encoding issue; corrected to portable Unicode escapes before shipping.
- Impeccable detector completed. Existing navigation tiny-text and map shadow warnings are outside this feature; forecast caption increased to 11px.
